...
\begin{proof}
  Using the sage mathematics computer algebra system, one can find that
  factors for this polynomial are $(3x + 1)(x^2 + 5x + 2)$, therefore $p(x)$
  is not irreducible.
